...
routes.post('/products', productController.writeProductsFile)
routes.get('/products', productController.readProductsFile)
routes.get('/products-stock', productController.calculateStock)
